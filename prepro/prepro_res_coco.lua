...
cmd:text()
cmd:text('Options')
cmd:option('-input_json','../data_coco/cocoqa_data_prepro.json','path to the json file containing vocab and answers')
...
cmd:option('-out_path', '../../VQA/Features/coco_img_features_res152.h5', 'path to output features')
