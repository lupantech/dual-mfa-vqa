...
def demo(net, image_name, image_file):
    ...
    if args.vis_result:
        vis_detections(im, dets, num, image_name)  

    # Save box features for viusalizing attention maps
    feat = dets[:, :4] # [4D]: box_feature-4 （Xmin,Ymin,Xmax,Ymax）
...
if __name__ == '__main__':   
    ...
    prototxt = os.path.join(cfg.MODELS_DIR, NETS[args.demo_net][0], # prototxt文件
    ...
    subtype = ['test2015/']
    output_file = h5py.File('../../VQA/Features/faster-rcnn_box4_19_test.h5','w')
